...
void main()
{
    vec3 _RimLightColor = RimLightColor;
    float _RimLightStart = RimLightStart;
    float _RimLightEnd = RimLightEnd;
    float _RimLightCoefficient = RimLightCoefficient;
    
    vec4 _LightSourcePosition_worldspace = LightSourcePosition_worldspace;
    vec3 _LightSourceAmbientColor = LightSourceAmbientColor;
    vec3 _LightSourceDiffuseColor = LightSourceDiffuseColor;
    vec3 _LightSourceSpecularColor = LightSourceSpecularColor;
    
    vec3 _LightSourceSpotDirection = LightSourceSpotDirection;
    float _LightSourceSpotExponent = LightSourceSpotExponent;
    float _LightSourceSpotCutoff = LightSourceSpotCutoff;
    float _LightSourceSpotCosCutoff = LightSourceSpotCosCutoff;
    float _LightSourceConstantAttenuation = LightSourceConstantAttenuation;
    float _LightSourceLinearAttenuation = LightSourceLinearAttenuation;
    float _LightSourceQuadraticAttenuation = LightSourceQuadraticAttenuation;
    vec3 _LightAmbientColor = LightAmbientColor;
    
    float _MaterialShininess = MaterialShininess;
    
    float _FogMaxDistance = FogMaxDistance;
    float _FogMinDistance = FogMinDistance;
    vec3 _FogColor = FogColor;
    float _FogDensity = FogDensity;
